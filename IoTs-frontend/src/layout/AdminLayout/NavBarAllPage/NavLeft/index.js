...
class NavLeftAllPage extends Component {
    ...
    render() {
        ...
        return (
            <Aux>
                ...
                {/* <li> <a href={DEMO.BLANK_LINK} className="b-brand">
                            <div className="b-bg">
...
export default connect(mapStateToProps, mapDispatchToProps)(windowSize(NavLeftAllPage));
