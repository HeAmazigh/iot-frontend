...
import NavLeftAllPage from "./NavLeft";
import NavRightAllPage from "./NavRight";
...
export default connect(mapStateToProps, mapDispatchToProps) (NavBarAllPage);
