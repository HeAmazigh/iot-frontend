                    ...
                    <Col>
                        <nav style={styles.navbar} class="navbar m-b-30 p-10">
                            ...
                            <ul class="nav">
                                ...
                                <li class="nav-item">
                                    <div class="dropdown">
                                        <button aria-haspopup="true" aria-expanded="false" id="bystatus" type="button" class="text-secondary nav-link dropdown-toggle btn btn-link"><span class="fa fa-line-chart"></span> By Status
                            </button>
                                    </div>
                                </li>
                            </ul>
                            <ul class="nav">
                                <li class="nav-item f-text active">
                                    <a href="/#" class="nav-link text-secondary" >Search: <span class="sr-only">(current)</span></a>
                                </li>
                                <li class="nav-item">
                                    <DropdownButton
                                        style={{ float: "right" }}
